...
Perform analytics on the cleaned production data and generate SQL queries to extract business insights.

📌 Tasks Completed
1. Calculated Total Revenue

Executed SQL query to compute total revenue generated from all purchases:

SELECT SUM(price) AS total_revenue
FROM production_clean;


✔ Returned the complete revenue generated by all customers.

2. Revenue by Country

Grouped orders by country to understand market performance:
...
Found the highest-paying customers:
...
Analyzed which payment modes customers prefer:
...
✔ Shows the most-used payment channels.
...
✔ Helps understand customer product preference.

6. Orders Per Country

Measured order distribution across countries:
